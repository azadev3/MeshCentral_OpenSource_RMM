/** 
* @description RenovarCentral plugin module
* @author Ryan Blenis
* @copyright 
* @license Apache-2.0
* @version v0.0.1
...
/*
Existing plugins:
https://raw.githubusercontent.com/ryanblenis/RenovarCentral-Sample/master/config.json
https://raw.githubusercontent.com/ryanblenis/RenovarCentral-DevTools/master/config.json
*/
...
module.exports.pluginHandler = function (parent) {
    ...
    // RenovarCentral now adheres to semver, drop the -<alpha> off the version number for later versions for comparing plugins prior to this change
    obj.versionToNumber = function(ver) { var x = ver.split('-'); if (x.length != 2) return ver; return x[0]; }

    // Check if the current version of RenovarCentral is at least the minimal required.
