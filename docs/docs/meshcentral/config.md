...
All possible configuration of RenovarCentral can be found in this file: <https://github.com/Ylianst/RenovarCentral/blob/master/meshcentral-config-schema.json>

See description for information about each item. 

```json
{
  "id": "https://raw.githubusercontent.com/Ylianst/RenovarCentral/master/meshcentral-config-schema.json",
  "$schema": "http://json-schema.org/draft-04/schema#",
  "description": "RenovarCentral configuration file schema",
  "type": "object",
  "properties": {
    "settings": {
      "type": "object",
      "properties": {
        "cert": { "type": "string", "description": "Set this to the primary DNS name of this RenovarCentral server." },
        "keepCerts": { "type": "boolean", "default": false, "description": "Force RenovarCentral to use the HTTPS and MPS certificates even if the name does not match the expected DNS value." },
        ...
        "mariaDB": {
          "type": "object",
          "description": "Add this section to connect RenovarCentral to a MariaDB database instance.",
          "properties": {
        ...
        "sqlite3": { "type": "boolean", "default": false, "description": "Set true to use SQLite3 as a local RenovarCentral database." },
        "mySQL": {
          "type": "object",
          "description": "Add this section to connect RenovarCentral to a MySQL database instance.",
          "properties": {
        ...
        "postgres": {
          "type": "object",
          "description": "Add this section to connect RenovarCentral to a PostgreSQL database instance.",
          "properties": {
        ...
        "WANonly": { "type": "boolean", "default": false, "description": "When enabled, only RenovarCentral WAN features are enabled and agents will connect to the server using a well known DNS name." },
        "LANonly": { "type": "boolean", "default": false, "description": "When enabled, only RenovarCentral LAN features are enabled and agents will find the server using multicast LAN packets." },
        ...
        "sessionKey": { "type": "string", "default": null, "description": "Password used to encrypt the RenovarCentral web session cookies. If null, a random one is generated each time the server starts." },
        ...
        "exactPorts": { "type": "boolean", "default": false, "description": "When set to true, RenovarCentral will only grab the required TCP listening ports or fail. It will not try to use the next available port of it's busy." },
        "allowLoginToken": { "type": "boolean", "default": false },
        "StrictTransportSecurity": { "type": ["boolean", "string"], "default": null, "description": "Controls the Strict-Transport-Security header, default is 1 year. Set to false to remove, true to force enable, or string to set a custom value. If set to null, RenovarCentral will enable if a trusted certificate is set." },
        "allowFraming": { "type": "boolean", "default": false, "description": "When enabled, the RenovarCentral web site can be embedded within another website's iframe." },
        ...
        "amtManager": { "type": "boolean", "default": true, "description": "When enabled, RenovarCentral will automatically monitor and manage Intel AMT devices." },
        ...
        "webPush": {
          "type": "object",
          "description": "When set with a valid email address, enables the RenovarCentral web push notification feature. Allows administrators to send browser notifications to users even if they are not looking at the RenovarCentral web site.",
        ...
        "publicPushNotifications": { "type": "boolean", "default": false, "description": "When true, this server uses RenovarCentral.com a push notification relay for Android notifications. Push notifications work even if the Android app is not open." },
        ...
        "InterUserMessaging": { "type": "array", "uniqueItems": true, "items": { "type": "string" }, "description": "Users in this list are allowed to send and receive inter-user messages. This can be used to implement bots or other software where RenovarCentral is used as data transport. See \"interuser\" websocket command in the code." },
        ...
        "tlsOffload": { "type": [ "boolean", "string" ], "default": false, "description": "When true, indicates that a TLS offloader is in front of the RenovarCentral server. More typically, set this to the IP address of the reverse proxy or TLS offloader so that IP forwarding headers will be trusted. For example: \"127.0.0.1,192.168.1.100\"." },
        ...
        "mpsTlsOffload": { "type": "boolean", "default": false, "description": "When set to true, indicate that TLS is being performed by a device in front of RenovarCentral." },
        ...
        "crowdsec": {
          ...
          "description": "Enabled the RenovarCentral built-in Crowdsec bouncer. This section is passed directly to the bouncer, all of the settings are documented at https://www.npmjs.com/package/@crowdsec/express-bouncer",
          "properties": {
          ...
          "properties": {
            ...
            "googleDrive": {
              ...
              "properties": {
                "folderName": {
                  "type": "string",
                  "default": "RenovarCentral-Backups",
    ...
    "domains": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "title": { "type": "string", "default": "RenovarCentral", "description": "The title of this web site. All web pages will have this title." },
          ...
          "trustedCert": { "type": "boolean", "default": "This value is normally auto-detected, when set to true, RenovarCentral assumes that the TLS certificate comes from a trusted CA and will insure download tools perform certificate checking." },
          "guestDeviceSharing": {
            "type": [ "boolean", "object" ],
            "default": true,
          ...
          "agentSelfGuestSharing": {
            "type": [ "boolean", "object" ],
            "default": false,
            "description": "When set to true, RenovarCentral Assistant can create it's own guest sharing links.",
            "properties": {
            ...
            "extralinks": {
              ...
              "items": {
                ...
                "properties": {
                  ...
                  "localport": {
                    "description": "The local port RenovarCentral Router would bind to. By default, a random available port is used.",
                    "default": 0,
                    "minimum": 0,
                    "maximum": 65535,
                    "type": "integer"
          ...
          "certUrl": {
            "type": "string",
            "format": "uri",
            "description": "https url when to get the TLS certificate that MeshAgent's will see when connecting to this server. This setting is used when a reverse proxy like NGINX is used in front of RenovarCentral."
          },
          "myServer": {
            "type": [ "object", "boolean" ],
            "additionalProperties": false,
          ...
          "ldapSaveUserToFile": { "type": "string", "default": null, "description": "When set to a filename, for example c:\\temp\\ldapusers.txt, RenovarCentral will save the LDAP user object to this file each time a user logs in. This is used for debugging LDAP issues." },
          ...
          "ldapSyncWithUserGroups": {
            "type": [ "boolean", "object" ],
            "default": false,
            "description": "When set to true or set to an object, RenovarCentral will synchronize LDAP user memberships to RenovarCentral user groups.",
            "additionalProperties": false,
            "properties": {
              "filter": {
                "type": [ "string", "array" ],
                "default": null,
                "description": "When set to a string or array of strings, only LDAP membership groups that includes one of the strings will be synchronized with RenovarCentral user groups."
              }
            }
          },
          "ldapSiteAdminGroups": {
          ...
          "agentCustomization": {
            ...
            "properties": {
              "displayName": { "type": "string", "default": "RenovarCentral Agent", "description": "The name of the agent as displayed to the user." },
              "description": { "type": "string", "default": "Renovar Agent background service", "description": "The description of the agent as displayed to the user." },
              "companyName": { "type": "string", "default": "Renovar Agent", "description": "This will be used as the path to install the agent, by default this is 'Renovar Agent' in Windows and 'meshagent' in other OS's." },
              "serviceName": { "type": "string", "default": "Renovar Agent", "description": "The name of the background service, by default this is 'Renovar Agent' in Windows and 'meshagent' in other OS's but should be set to an all lower case, no space string." },
              "installText": { "type": "string", "default": null, "description": "Text string to show in the agent installation dialog box." },
              "image": { "type": "string", "default": null, "description": "The filename of a image file in .png format located in meshcentral-data to display in the RenovarCentral Agent installation dialog, image should be square and from 64x64 to 200x200." },
          ...
          "assistantCustomization": {
            "type": "object",
            "additionalProperties": false,
            "description": "Use this section to customize the RenovarCentral Assistant.",
            "properties": {
              "title": { "type": "string", "default": "RenovarCentral Assistant", "description": "Name to show as RenovarCentral Assistant dialog title." },
              "image": { "type": "string", "default": null, "description": "The filename of a image file in .png format located in meshcentral-data to display in RenovarCentral Assistant, image should be square and from 64x64 to 128x128." },
              "fileName": { "type": "string", "default": "meshagent", "description": "The RenovarCentral Assistant filename." }
            }
          },
          "androidCustomization": {
            "type": "object",
            "additionalProperties": false,
            "description": "Use this section to customize the RenovarCentral Agent for Android.",
            "properties": {
              "title": { "type": "string", "default": "RenovarCentral Agent", "description": "Displayed on top of the RenovarCentral Agent for Android." },
              "subtitle": { "type": "string", "default": null, "description": "Subtitle displayed until the title on the toolbar." },
              "image": { "type": "string", "default": null, "description": "The filename of a image file in .png format located in meshcentral-data to display in RenovarCentral Agent for Android, image should be square and from 64x64 to 128x128." }
            }
          },
          "ipBlockedUserRedirect" : { "type": "string", "default": null, "description": "If set, a user from a banned IP address will be redirected to this URL." },
          ...
          "amtManager": {
            ...
            "properties": {
              "TlsConnections": { "type": "boolean", "default": true, "description": "When set to false, RenovarCentral will use TLS to connect to Intel AMT, this is not recommended." },
              "TlsAcmActivation": { "type": "boolean", "default": false, "description": "When set to false, RenovarCentral will not attempt a TLS ACM activation on Intel AMT v14+" },
              "AdminAccounts": {
              ...
              "TlsRootCert": {
                "description": "Specifies a certificate and private key to use to issue Intel AMT TLS certificates. By default the RenovarCentral self-signed root certificate is used.",
                "type": "object",
                "properties": {
                  "certpfx": {
          ...
          "assistantConfig": { "type": "array", "uniqueItems": true, "items": { "type": "string" }, "default": null, "description": "Key and values to add to the RenovarCentral Assistant .msh file" },
          ...
          "sendgrid": {
            ...
            "description": "Connects RenovarCentral to the SendGrid email server, allows RenovarCentral to send email messages for 2FA or user notification.",
            "type": "object",
            "properties": {
          ...
          "smtp": {
            ...
            "description": "Connects RenovarCentral to a SMTP email server, allows RenovarCentral to send email messages for 2FA or user notification.",
            "type": "object",
            "properties": {
              "name": {
                "type": "string",
          ...
          "sendmail": {
            ...
            "description": "Makes RenovarCentral send emails using the Unix sendmail command. Allows RenovarCentral to send email messages for 2FA or user notification.",
            "type": "object",
            "properties": {
              ...
              "oidc": {
                ...
                "properties": {
                  ...
                  "groups": {
                    "type": "object",
                    "properties": {
                      "required": { "type": [ "string", "array" ], "description": "When set, the user must be part of one of the OIDC user groups to login to RenovarCentral." },
                      "siteadmin": { "type": [ "string", "array" ], "description": "When set, users part of these groups will be promoted with site administrator in RenovarCentral, users that are not part of these groups will be demoted." },
                      "sync": {
                        "type": [ "boolean", "object" ],
                        "description": "Allows some or all ODIC user groups to be mirrored within RenovarCentral as user groups.",
                        "properties": {
                          "enabled": { "type": "boolean", "default": false },
                          "filter": { "type": [ "string", "array" ], "description": "When set, limits what OIDC groups are mirrored into RenovarCentral user groups." }
                        }
                      }
                    }
                  }
    ...
    "letsEncrypt": {
      ...
      "properties": {
        ...
        "names": { "type": "string" },
        "skipChallengeVerification": { "type": "boolean", "default": false, "description": "By default, RenovarCentral will perform a self-test to make sure HTTP port 80 can respond correctly before making a request to Let's Encrypt. In some cases, this self-test can't work and must be skipped." },
    ...
    "sms": {
      "title": "SMS provider",
      "description": "Connects RenovarCentral to a SMS text messaging provider, allows RenovarCentral to send SMS messages for 2FA or user notification.",
      "oneOf": [
        {
          "type": "object",
          "properties": {
    ...
    "messaging": {
      ...
      "description": "This section allow RenovarCentral to send messages over user messaging networks like Telegram",
      "type": "object",
      "properties": {
        "telegram": {
          "type": "object",
        ...
        "discord": {
          ...
          "properties": {
            ...
            "token": { "type": "string", "description": "A Discord bot token that RenovarCentral will use to login to Discord." }
          },
          "required": [ "token" ]
        },
        "xmpp": {
        ...
        "pushover": {
          ...
          "properties": {
            "token": { "type": "string", "description": "A Pushover application token that RenovarCentral will use to login." }
          },
          "required": [ "token" ]
        },
        "ntfy": {
