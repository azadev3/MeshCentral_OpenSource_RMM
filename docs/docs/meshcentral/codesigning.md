...
RenovarCentral comes with authenticode.js, you can run it like this:
...
```
RenovarCentral Authenticode Tool.
Usage:
...
Now that RenovarCentral customizes and signs the agent, you can set that value to anything you like.
