...
| - meshcentral/        # this folder contains the persistent data
  | - data/             # RenovarCentral data-files
...
services:
  meshcentral:
    ...
    ports:
      # RenovarCentral will moan and try everything not to use port 80, but you can also use it if you so desire, just change the config.json according to your needs
      - 8086:443
    env_file:
      - .env
    volumes:
