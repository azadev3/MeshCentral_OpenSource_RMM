...
/** 
* @description MeshCmd, command line tool for Intel AMT and RenovarCentral.
...
var settings = null;
var meshCmdVersion = '***Mesh*Cmd*Version***'; // Dynamically replaced with RenovarCentral version
...
function run(argv) {
    ...
    if (settings.action == null) {
        console.log('RenovarCentral Command (MeshCmd) ' + meshCmdVersion);
        console.log('No action specified, use MeshCmd like this:\r\n');
        console.log('  meshcmd [action] [arguments...]\r\n');
        console.log('Valid RenovarCentral actions:');
    ...
    if (settings.action == 'help') {
        ...
        if (action == 'route') {
            console.log("The route action is used along with a RenovarCentral account to map a local TCP port to a remote port on any computer on your RenovarCentral account. This action requires many arguments, to avoid specifying them all it's best to download the meshaction.txt file from the web site and place it in the current folder. Example usage:\r\n\r\n  (Place meshaction.txt file in current folder)\r\n  meshcmd route --pass myAccountPassword");
            ...
            console.log('\r\nPossible arguments:\r\n');
            console.log('  --url [wss://server]      The address of the RenovarCentral server.');
    ...
    if (settings.action == 'amtstartconfig') {
        ...
        // RenovarCentral Router, port map local TCP port to a remote computer
        ...
        if (settings.serverurl != null) { startRouter(); } else { discoverMeshServer(); } // Start RenovarCentral Router
        ...
        // Start Intel AMT configuration
        if ((settings.url == null) || (typeof settings.url != 'string') || (settings.url == '')) { console.log('No RenovarCentral server URL specified, use --url [url].'); exit(1); return; }
...
//
// RenovarCentral TCP port router
//
