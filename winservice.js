...
function start() {
    ...
    try {
        ...
        if (runarg == null) { console.log('ERROR: Unable to find RenovarCentral.js'); process.exit(255); return; }
        ...
        const servicelog = new eventlogger('RenovarCentral');
        ...
        if (((args.install == true) || (args.uninstall == true) || (args.start == true) || (args.stop == true) || (args.restart == true))) {
            ...
            var svc = new service({ name: 'RenovarCentral', description: 'RenovarCentral Remote Management Server', script: path.join(__dirname, 'winservice.js'), env: env, wait: 2, grow: 0.5 });
            ...
            svc.on('stop', function () { console.log('RenovarCentral service stopped.'); if (args.stop) { process.exit(); } if (args.restart) { console.log('Holding 5 seconds...'); setTimeout(function () { svc.start(); }, 5000); } });
        ...
        // This module is only called when RenovarCentral is running as a Windows service.
