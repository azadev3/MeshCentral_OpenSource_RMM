You can help translate RenovarCentral into other languages pretty easily. In this folder is a
...
GitHub pull request on the RenovarCentral GitHub to update the "translate.json" file, or send the
