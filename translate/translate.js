...
function startEx(argv) {
    ...
    if (directRun) { log('RenovarCentral web site translator'); }
    if (command == null) {
        ...
        log('    Extract all RenovarCentral strings from web pages and generate the languages.json file.');
        log('');
        ...
        log('    Translate all RenovarCentral strings using the languages.json file.');
        log('');
        ...
        log('');
        log('  MINIFYALL');
        log('    Minify the main RenovarCentral english web pages.');
        log('');
    ...
    // Extract or translate all RenovarCentral strings
